    ...
    private static func defaultLanguagePackPayloads() -> [LanguagePackExportPayload] {
        ...
        let en = LanguagePackExportPayload(
            ...
            strings: [
                ...
                "row.appearance.darkMode": "Dark Mode",
                "row.appearance.darkMode.subtitle": "Turn off to use light mode",
                ...
                "row.trail.disableFade": "Disable Fade / Force Solid",
                "row.trail.disableFade.subtitle": "Keep trail/effect colors at configured opacity without fade-out",
                ...
                "row.trail.neonPrimaryWidthRatio": "Primary Width Ratio",
                "row.trail.electricDensity": "Arc Density",
                "row.trail.electricLength": "Arc Length",
                "row.trail.electricWidth": "Arc Width",
                "row.trail.inkDensity": "Ink Density",
                "row.trail.inkSize": "Ink Size",
                "row.trail.inkLifetime": "Ink Lifetime (ms)",
                "row.trail.inkColors": "Ink Colors",
                "row.trail.particleDensity": "Particle Density",
                "row.trail.particleSize": "Particle Size",
                "row.trail.particleLifetime": "Particle Lifetime (ms)",
                "row.trail.particleSpeed": "Particle Speed",
                "row.trail.particleColors": "Particle Colors",
                ...
                "row.click.particleExplosion.density": "Particle Density",
                "row.click.particleExplosion.size": "Particle Size",
                "row.click.particleExplosion.lifetime": "Particle Lifetime (ms)",
                "row.click.particleExplosion.speed": "Particle Speed",
                "row.click.particleExplosion.colors": "Particle Colors",
                ...
                "clickStyle.particleExplosion": "Particle Explosion",
            ]
        )
        return [zhHans, en]
    }
